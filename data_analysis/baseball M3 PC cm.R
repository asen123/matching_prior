# Using the common mean model with arcsine transformed y
...
save.image("baseball_pb_cm_S2_1_100.RData")
write.csv(post_cov, "baseball_pb_cm_S2_1_100.csv", row.names = F)
